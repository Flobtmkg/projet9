...
public class EtatReservationMapper {
    ...
    public static EtatReservation toDto(EtatReservationEntity etatReservationEntity) {
        return new EtatReservation(etatReservationEntity.getNumEtat(), etatReservationEntity.getCode(), etatReservationEntity.getLibelle());
    }

    public static EtatReservationEntity toEntity(EtatReservation etatReservation) {
        return new EtatReservationEntity(etatReservation.getNumEtat(), etatReservation.getCode(), etatReservation.getLibelle());
    }
}
